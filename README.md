...
Привет Друг приветствую тебя на свое первом проекте Игры разума!
Для того что бы начать играть в игры которые я тебе приготовил тебе нужно:
Склонировать репозиторий к себе через команду git clone https://github.com/EdmartEmpty/php-project-45.git 
